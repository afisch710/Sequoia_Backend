...
public class GetNearbyNotesTest {
	...
	public void test() {
		...
		System.out.println("User 1 notes: " + db.getNearbyNotes(id1, 1, 1));
//		System.out.println("User 2 notes: " + db.getNearbyNotes(id2, 1, 1));
//		System.out.println("User 3 notes: " + db.getNearbyNotes(id3, 1, 1));
		
		assertEquals(db.getNearbyNotes(id1, 1, 1).contains(noteId1), true);
		assertEquals(db.getNearbyNotes(id1, 1, 1).contains(noteId2), true);
		assertEquals(db.getNearbyNotes(id1, 1, 1).contains(noteId3), true);
		
		assertEquals(db.getNearbyNotes(id2, 1, 1).contains(noteId1), true);
		assertEquals(db.getNearbyNotes(id2, 1, 1).contains(noteId2), true);
		assertEquals(db.getNearbyNotes(id2, 1, 1).contains(noteId3), true);
		
		assertEquals(db.getNearbyNotes(id3, 1, 1).contains(noteId1), true);
		assertEquals(db.getNearbyNotes(id3, 1, 1).contains(noteId2), true);
		assertEquals(db.getNearbyNotes(id3, 1, 1).contains(noteId3), false);
		
		assertEquals(db.getNearbyNotes(id4, 1, 1).contains(noteId1), true);
		assertEquals(db.getNearbyNotes(id4, 1, 1).contains(noteId2), false);
		assertEquals(db.getNearbyNotes(id4, 1, 1).contains(noteId3), false);
	}
